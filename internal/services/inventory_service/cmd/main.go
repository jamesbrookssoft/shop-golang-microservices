...
import (
	...
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/inventory/configurations"
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/inventory/data"
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/inventory/data/repositories"
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/inventory/mappings"
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/inventory/models"
	"github.com/jamesbrookssoft/shop-golang-microservices/internal/services/inventory_service/server"
	"go.uber.org/fx"
	"gorm.io/gorm"
)
